# Generated by Powerlevel10k configuration wizard on 2019-12-19 at 11:14 CET.
...
# angled separators, sharp heads, flat tails, 2 lines, disconnected, left frame, dark,
# sparse, many icons, concise, transient_prompt.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=8
